...
const GoogleAuthSignup = ({ setUser }) => {
    ...
    return (
        <div className="min-h-screen bg-gray-900 text-yellow-500 flex items-center justify-center p-4">
            <div className="bg-gray-800/60 backdrop-blur-lg border border-gray-700/50 p-8 rounded-2xl shadow-2xl max-w-md w-full">
                ...
                <div className="mb-8">
                    ...
                    <div className="mt-4 p-4 bg-blue-900/20 border border-blue-600/30 rounded-xl backdrop-blur-sm">
                ...
                {/* Note for regular signup */}
                <div className="mt-6 p-4 bg-orange-900/20 border border-orange-600/30 rounded-xl backdrop-blur-sm">
                    <div className="flex items-start space-x-3">
                        <svg
                        ...
                        <div className="text-sm text-orange-300">
                            ...
                            <p className="mt-1">
                                Regular signup won't include automatic calendar integration. You'll need to connect your
                                calendar manually later.
                            </p>
                        </div>
                    </div>
                </div>
